...
const PatientRequestDetailPopup = ({ open, onClose, request }) => {
        ...
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            ...
            <DialogContent>
                <form>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div style={{ flex: 1 }}>
                            <Typography variant="h8" color="initial">Blood bag id: {request.dedicatedBloodBag}</Typography>
                        </div>
                    </div>
...
export default PatientRequestDetailPopup;
