...
export default function PatientSideNav() {
  ...
  console.log("From PatientSideNav");
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>navigate('/transfusionhistory')}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Transfusion history" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
